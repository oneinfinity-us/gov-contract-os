"""Placeholder connector for City of Bellevue procurement.

NOT YET IMPLEMENTED. The City of Bellevue's public procurement portal/platform
has not been researched/verified for automated access in this MVP round - see
...
SOURCE_AGENCY = "City of Bellevue"
...
class CityOfBellevueConnector(Connector):
    ...
    def health_check(self) -> ConnectorHealth:
        return ConnectorHealth(
            ...
            reason=(
                "Connector not implemented yet. City of Bellevue's public procurement "
                "portal/platform has not been researched/verified in this round."
            ),
            recommended_alternative=(
                "Check the City of Bellevue's official purchasing/procurement pages "
                "manually; confirm the actual platform, ToS, and robots.txt before "
